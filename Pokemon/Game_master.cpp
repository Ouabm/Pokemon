...
void GameMaster::handleInput(sf::Event& event) {
    ...
    if (event.type == sf::Event::KeyPressed) {
        ...
        if (event.key.code == sf::Keyboard::Z) selectMove(2, 0);
        else if (event.key.code == sf::Keyboard::Q) selectMove(2, 1);
        else if (event.key.code == sf::Keyboard::S) selectMove(2, 2);
        else if (event.key.code == sf::Keyboard::D) selectMove(2, 3);
...
float GameMaster::calculateTypeEffectiveness(const std::string& moveType, const std::string& defenderType) {
    ...
    if (moveType == "Water" && defenderType == "Fire") return 2.0f;
    if (moveType == "Fire" && defenderType == "Grass") return 2.0f;
    if (moveType == "Grass" && defenderType == "Water") return 2.0f;
    if (moveType == "Electric" && defenderType == "Water") return 2.0f;
    if (moveType == "Ground" && defenderType == "Electric") return 2.0f;
    if (moveType == "Psychic" && defenderType == "Fighting") return 2.0f;
    if (moveType == "Dragon" && defenderType == "Dragon") return 2.0f;
    
    // Not very effective (0.5x damage)
    if (moveType == "Water" && defenderType == "Water") return 0.5f;
    if (moveType == "Fire" && defenderType == "Water") return 0.5f;
    if (moveType == "Grass" && defenderType == "Fire") return 0.5f;
    if (moveType == "Electric" && defenderType == "Grass") return 0.5f;
    if (moveType == "Electric" && defenderType == "Ground") return 0.0f; // Immune
